...
namespace WindowsFormsApp3
{
    public partial class UC_PhieuNhap : UserControl
    {
        ...
        void loadData()
        {
            dgvPhieuNhap.DataSource = BUS_PhieuNhap.Intance.GetListPN();
        ...
        {
            Form_PhieuNhap frmPN = new Form_PhieuNhap();
            frmPN.ShowDialog();
        }
        ...
        private void btnXoaPhieu_Click(object sender, EventArgs e)
        {
            ...
            if (dlr == DialogResult.Yes)
            {
                ...
                if (BUS_PhieuNhap.Intance.xoaPN(dgvPhieuNhap.Rows[VT].Cells[0].Value.ToString().Trim()))
                {
        ...
        private void btnSua_Click(object sender, EventArgs e)
        {
            ...
            Form_PhieuNhap frm = new Form_PhieuNhap(maPN);
            frm.ShowDialog();
        }
        ...
        {
            dgvPhieuNhap.DataSource = BUS_PhieuNhap.Intance.TimKiemPN(txtTimKiem.Text);
        }
